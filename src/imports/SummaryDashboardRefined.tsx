import svgPaths from "./svg-e6ezv5wirx";
...
function LinkFitnessCenter() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-[112.86px] p-[12px] top-1/2" data-name="Link - Fitness Center">
...
function LinkHistory() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-[188.11px] p-[12px] top-1/2" data-name="Link - History">
      <div className="flex flex-col font-['Material_Symbols_Outlined:Thin',sans-serif] h-[24px] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-[rgba(255,255,255,0.6)] w-[24.103px]">
...
function LinkPerson() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col items-start left-[263.36px] p-[12px] top-1/2" data-name="Link - Person">
      <div className="flex flex-col font-['Material_Symbols_Outlined:Thin',sans-serif] h-[24px] justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-[rgba(255,255,255,0.6)] w-[24.103px]">
...
export default function SummaryDashboardRefined() {
  return (
